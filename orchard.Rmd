...
## what is the probability of overestimating the true number of apples?
for(i in 1:30){
tt <- table(do.call(rbind, lapply(1:n.sims, function(ns){stochastic.list[[ns]][i,"estimate"] > sum(sto.df[sto.df$sim.number==ns,"n.apples"])})))
print(paste0("n=", i, " p(overestimate)=", tt[1]/sum(tt)))
}
