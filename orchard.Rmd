...
Why is this the case that our number of samples doesn't improve our chance of not overestimating the number of apples in the orchard? And why is it not 50% across the board? Why are the probabilites of overestimating the number of apples smaller when we have an odd number of samples?
